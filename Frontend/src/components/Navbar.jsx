...
export default function Navbar() {
  ...
  return (
    <header className="w-full border-b border-outline-variant/30 bg-surface-container-lowest/80 backdrop-blur-sm sticky top-0 z-50 transition-colors duration-300"
      style={{ borderBottomColor: "color-mix(in srgb, var(--color-outline-variant) 30%, transparent)" }}
    >
